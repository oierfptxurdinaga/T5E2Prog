	...
	public APP(Erabiltzaile erab, Federazioa federazioa) {
		...
		addWindowListener(new java.awt.event.WindowAdapter() {
			public void windowClosing(java.awt.event.WindowEvent e) {
				int opcion = JOptionPane.showConfirmDialog(null, "Ziur zaude programa itxi nahi duzula?", "Irten",
	...
	private void tabsEguneratu() {
		...
		if (d != null) {
			...
			if (erabAktiboa instanceof ErabiltzaileAdministraria) {
				...
				tabs.addTab("Presidentea - Taldea", new PanelPresi(erabAktiboa, federazioa.getTaldeGuztiak()));
			}
		}
